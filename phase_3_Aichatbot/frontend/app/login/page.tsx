...
const LoginPage: React.FC = () => {
  ...
  const handleLogin = async (credentials: { email: string; password: string }) => {
    console.log('LoginPage: handleLogin called with credentials:', credentials);
    setIsLoading(true);
    setError(null);
    ...
    try {
      ...
      console.log('LoginPage: Login successful, redirect should be handled by AuthProvider');
